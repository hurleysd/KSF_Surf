...
namespace KSF_Surf.Views
{
    ...
    public partial class InfoPage : ContentPage
    {
        public InfoPage()
        {
            ...
            CopyrightsLabel.Text = "KSF data provided with permission from the owner, unt0uch4bl3. Twitch data provided in accordance with the Twitch Developer Services Agreement." +
