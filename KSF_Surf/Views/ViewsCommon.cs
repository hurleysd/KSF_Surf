...
namespace KSF_Surf.Views
{
    internal static class ViewsCommon
    {
        ...
        internal static async Task DisplayNoConnectionAlert(ContentPage p)
        {
            await p.DisplayAlert("Could not connect to KSF!", "Please connect to the Internet", "OK");
        }

        internal static async Task DisplayNoSteamConnectionAlert(ContentPage p)
        {
            await p.DisplayAlert("Could not connect to Steam!", "Please connect to the Internet", "OK");
        }

        internal static async Task DisplayNoWebConnectionAlert(ContentPage p)
        {
            await p.DisplayAlert("Could not open web page!", "Please connect to the Internet", "OK");
        }

        internal static async Task DisplayProfileFailureAlert(ContentPage p, bool includeRank)
        {
